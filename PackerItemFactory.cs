...
// Type: Slb.Production.Engineering.Views.Well.PackerItemFactory
...
public class PackerItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) new PackerWellboreItemView();
  }
}

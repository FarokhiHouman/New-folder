...
// Type: Slb.Production.Engineering.Views.Well.TubingPlugItemFactory
...
public class TubingPlugItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) new TubingPlugWellboreItemView();
  }
}

...
// Type: Slb.Production.Engineering.Views.Well.SlidingSleeveItemFactory
...
public class SlidingSleeveItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) new SlidingSleeve(ColorCode.Default);
  }
}

...
// Type: Slb.Production.Engineering.Views.Well.NodalPointItemFactory
...
public class NodalPointItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) StingrayWellboreAdapter.NewNodal((string) null, true);
  }
}

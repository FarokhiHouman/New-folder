...
// Type: Slb.Production.Engineering.Views.Well.IWellViewNavigateFromValidation
...
public interface IWellViewNavigateFromValidation
{
  bool NavigateTo(ValidationIssue issue);

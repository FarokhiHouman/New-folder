...
// Type: Slb.Production.Engineering.Views.Well.IWellViewNavigationService
...
public interface IWellViewNavigationService
{
  void Register(IWellViewNavigateFromValidation navigator);
}

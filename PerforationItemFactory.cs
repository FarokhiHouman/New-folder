...
// Type: Slb.Production.Engineering.Views.Well.PerforationItemFactory
...
public class PerforationItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) StingrayWellboreAdapter.NewPerforationSymbol();
  }
}

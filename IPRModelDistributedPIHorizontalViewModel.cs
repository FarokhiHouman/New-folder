...
// Type: Slb.Production.Engineering.Views.Well.IPRModelDistributedPIHorizontalViewModel
...
public class IPRModelDistributedPIHorizontalViewModel(
  DistributedCompletionModel model,
  IFluidLinkViewModel link,
  bool performCalculation = true) : IPRModelViewModel<DistributedCompletionModel>(model, link, performCalculation: performCalculation)
{
}

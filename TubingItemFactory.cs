...
// Type: Slb.Production.Engineering.Views.Well.TubingItemFactory
...
public class TubingItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    TubingWellboreItemView wellboreItem = new TubingWellboreItemView();
    wellboreItem.Length = 1000.0;
    wellboreItem.ID = 0.03175;
    wellboreItem.OD = 0.04445;
    return (BaseWellboreItem) wellboreItem;
  }
}

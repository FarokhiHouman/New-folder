...
// Type: Slb.Production.Engineering.Views.Well.ICreateWellStringItem
...
public interface ICreateWellStringItem
{
  ModelItem CreateWellStringItem(WellString wellString);

  bool CanCreateItem(WellString wellString);

  WellHead WellHead { get; set; }
}

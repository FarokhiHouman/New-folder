...
// Type: Slb.Production.Engineering.Views.Well.Tubulars.TailTubingDetailedViewValidation
...
public class TailTubingDetailedViewValidation : CasingDetailedViewValidation
{
  protected override SectionType SectionType => SectionType.TailPipe;
}

...
// Type: Slb.Production.Engineering.Views.Well.WellboreSchematic.FlowSectionBuilder.ISchematicUiElementProvider
...
public interface ISchematicUiElementProvider
{
  bool ContainsKey(ModelItem key);

  FrameworkElement GetElement(ModelItem key);
}

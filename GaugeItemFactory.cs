...
// Type: Slb.Production.Engineering.Views.Well.GaugeItemFactory
...
public class GaugeItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    return (BaseWellboreItem) StingrayWellboreAdapter.NewGauge((string) null, true);
  }
}

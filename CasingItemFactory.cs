...
// Type: Slb.Production.Engineering.Views.Well.CasingItemFactory
...
public class CasingItemFactory : WellboreItemFactory
{
  public override BaseWellboreItem CreateWellboreItem()
  {
    CasingWellboreItemView wellboreItem = new CasingWellboreItemView();
    wellboreItem.Length = 1000.0;
    wellboreItem.ID = 0.3;
    wellboreItem.OD = 0.32;
